...
function AboutUs() {
    return (
        <>
            <Navbar />
            <main className="relative overflow-hidden bg-base-100 from-base-100/30 via-base-100 to-base-100/50 dark:from-base-100/20 dark:via-base-100 dark:to-base-100/30">
