...
import { 
  ...
  RiEarthLine, 
  RiBankLine, 
  RiHome6Line,  // ✅ Replaced RiHomeDoorLine with this valid icon
  RiTimeLine, 
...
function BuyerDashboard() {
  ...
  const stats = [
    ...
    },
    {
      title: "OFW-friendly",
      value: "1,256",
      subtitle: "Remote buying process",
      icon: RiEarthLine,
      trend: "+5% this week",
    ...
    {
      title: "Pag-IBIG Approved",
      value: "892",
      subtitle: "Government financing",
      icon: RiBankLine,
      trend: "+8% this month",
    ...
    },
    {
      ...
      icon: RiHome6Line,  // ✅ Updated icon here
      trend: "+3% this week",
  ...
  return (
    <DashboardLayout userRole="buyer">
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className="min-h-screen bg-base-100 p-4 ml-20" // Added ml-20 for sidebar space
      >
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-primary-content/70 max-w-md">
                    Browse and track your favorite properties. We've found some new listings that match your preferences.
                  </p>
                </div>
                <div className="hidden lg:block">
                  <div className="stats bg-primary-content/10 text-primary-content">
                    <div className="stat place-items-center">
                      <div className="stat-title text-primary-content/80">Active</div>
                      <div className="stat-value text-2xl">25</div>
